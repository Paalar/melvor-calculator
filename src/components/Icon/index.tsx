...
const svgRoot = 'https://melvorcdn.fra1.cdn.digitaloceanspaces.com/current/assets/media/';
...
const Icon: React.FC<{ pageName: SkillNamesType, size?: string }> = ({ pageName, size }) => {
